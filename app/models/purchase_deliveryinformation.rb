class PurchaseDeliveryinformation
  ...
  with_options presence: true do
    ...
    validates :address,     format: { with: /\A(?:\p{Hiragana}|\p{Katakana}|[ー－]|[一-龠々])+\z/ } # 全角ひらがな、全角カタカナ、漢字（鬼車）
  ...
  def save
    ...
    Deliveryinformation.create(postal_code: postal_code,prefecture_id: prefecture_id, address: address, city: city, building: building, phone_number: phone_number, purchase_id: purchase.id)
  end
end